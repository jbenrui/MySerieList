...
<html>
    <head>
     ...
     <%
          ...
          String confirmacion =".";
          ResultSet listado = s.executeQuery("(SELECT * FROM listaserie JOIN generoprincipal on listaserie.idGenero=generoprincipal.idGenero "
                  + "                                                   JOIN tipo on listaserie.idTIPO=tipo.idTipo "
                  + "                                                   JOIN usuario on listaserie.idUser=usuario.idUser "
                  + "                                                   WHERE Alias='"+usuario+"' AND NomList='"+busca+"')");
