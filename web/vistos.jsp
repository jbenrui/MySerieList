...
<html>
    ...
    <%
          ...
          String confirmacion =".";
          ResultSet listado = s.executeQuery("(SELECT * FROM listaserie JOIN generoprincipal on listaserie.idGenero=generoprincipal.idGenero JOIN tipo on listaserie.idTIPO=tipo.idTipo JOIN usuario on listaserie.idUser=usuario.idUser WHERE Alias='"+usuario+"' AND estado='Visto')");
        ...
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <a class="btn btn-info btn-block"href="pendientes.jsp">Ver Pendientes</a>
            </div>
          </div>
        </div>
      </div>
